...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp1(object p0, byte[] p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp3(UnityEngine.GameObject p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
		    ...
		    if (type == typeof(util.MyAction))
			{
			    return new util.MyAction(__Gen_Delegate_Imp0);
			}
		
		    if (type == typeof(util.MyActionTwo))
			{
			    return new util.MyActionTwo(__Gen_Delegate_Imp1);
			}
		
		    if (type == typeof(util.MyActionOne))
			{
			    return new util.MyActionOne(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(util.LuaEventDispatcher.unityAction3))
			{
			    return new util.LuaEventDispatcher.unityAction3(__Gen_Delegate_Imp2);
			}
		
		    if (type == typeof(EventTriggerListener.VoidDelegate))
			{
			    return new EventTriggerListener.VoidDelegate(__Gen_Delegate_Imp3);
			}
